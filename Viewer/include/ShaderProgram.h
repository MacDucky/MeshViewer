...
public:
    ...
    void setUniform(const GLchar* name, const glm::vec3 v[],int size);   //for array of uniform vec3.
    void setUniform(const GLchar* name, const glm::mat4 m[],int size);   //for array of uniform matrices.
